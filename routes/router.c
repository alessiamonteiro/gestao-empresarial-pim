...
void router(char buffer[1024])
{
  ...
  char *rota_criar_relatorio_clientes = strstr(buffer, "POST/relatorios/clientes");
  ...
  if (rota_criar_relatorio_clientes) return criar_relatorio_clientes_controller(buffer);
